...
class PublicationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Thesis",
            {"classes": ("collapse",), "fields": ("school", "location", "country")},
        ),
        ("References", {"fields": ("citekey", "tags", "code", "url", "doi", "isbn")}),
        ("Description", {"fields": ("abstract", "note")}),
        ("Media", {"classes": ("collapse",), "fields": ("pdf", "image", "thumbnail")}),
    )
